...
frontend Vitest、F-02、F-04/F-13、F-06、F-08 logout、F-09、F-11、F-15 与 F-16 已在本地代码侧关闭；F-05 实现完成，但 Node `19.7.0` 复演仅验证了 `.nvmrc` 白名单完整性，锁定 Node `22.22.2` / npm `10.9.7` 的本地完整门禁及隔离测试服务器审核均待完成。F-02/F-09/F-11/F-16 也已通过隔离 MySQL 8.4 测试服务器审核。F-04/F-13、F-05、F-06、F-14 与 F-15 的专用测试服务器门禁仍开放；F-15 首次运行因验收 harness 所有权边界失败，修复后的第二次运行待重新授权。F-12 的 F-11 前置已经满足，但 F-12 实现和验收仍未完成。生产 frontend/backend bundle、miniapp 包与 `0004`/`0005`/`0006`/`0007`/`0008`/`0009` 仍须在各自批准的发布或维护窗部署/执行后才对线上生效，不能据此标记为生产已完成。
